...
public class ChatLink extends TableImpl<ChatLinkRecord> {
     ...
     */
    public final TableField<ChatLinkRecord, Integer> ID = createField(DSL.name("ID"), SQLDataType.INTEGER.nullable(false).identity(true), this, "");
    ...
    @Override
    @NotNull
    public Identity<ChatLinkRecord, Integer> getIdentity() {
        return (Identity<ChatLinkRecord, Integer>) super.getIdentity();
    }
